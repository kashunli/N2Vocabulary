...
# Paths resolved relative to this script (inside wordsAndExerciseInHtml/scripts/)
_HERE = Path(__file__).parent.resolve()
JSON_DIR = _HERE.parent.parent / "json"                 # N2Vocabulary/json/
TOOL_DATA_DIR = _HERE.parent / "exercise_json" / "n2"  # wordsAndExerciseInHtml/exercise_json/n2/
