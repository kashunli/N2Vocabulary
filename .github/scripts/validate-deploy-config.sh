...
# Keep the VPS boundary explicit so missing connection details stop before any
# build work. Host-key pinning is optional; the deploy script discovers the key
# when VPS_KNOWN_HOSTS has not been configured yet.
