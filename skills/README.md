...
This folder gathers reusable workflow skills so they can be reviewed one by one without hunting through the repository root.

## Current Skills

- `cutTwice/` - pair-first audio cutting, pair transcription, and word/sentence clip splitting.
- `makeAnkiCards/` - Anki deck building, validation, clean DB conversion, and explanation merge helpers.
